...
TODO:
1. Выучить теорию!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
2. Есть массив из десяти элементов, заполненный случайными числами.
...
3. В проекте DynamicMemory реализовать следующие функции:
	??? push_back(???);	//добавляет значение в конец динамического массива
	??? push_front(???);//добавляет значение в начало динамического массива
	??? insert(???);	//вставляет значение в динамический массив по указанному индексу
